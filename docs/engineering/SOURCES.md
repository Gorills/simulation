...
| Godot/GDScript integer boundary is signed 64-bit | Godot 4.7 [`Variant`](https://docs.godotengine.org/en/4.7/classes/class_variant.html) and [binary serialization integer format](https://docs.godotengine.org/en/4.7/tutorials/io/binary_serialization_api.html) | `EntityId` / observed-world GDExtension boundary |
